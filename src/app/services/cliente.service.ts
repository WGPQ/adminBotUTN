...
export class ClienteService {
  ...
  headers = new HttpHeaders({
    ...
    Authorization:
      'Bearer ' +
      (this.authservices!.leerToken() ||
        this.authservices!.leerTokenBlog() ||
        ''),
  });
  ...
  obtenerClientes(rol: string, listar: Listar): Observable<Cliente[]> {
    ...
    return this.http
      .get(this.appUrl + this.apiCliente + '/Listar', {
        params: params,
  ...
  obtenerCliente(id?: string): Observable<Cliente> {
    return this.http
      .get<Cliente>(this.appUrl + this.apiCliente + '/Obtener/' + id, {
        headers: this.headers,
      })
      .pipe(
        map((resp: any) => {
  ...
  ingresarCliente(cliente: Cliente): Observable<any> {
    return this.http.post(
      this.appUrl + this.apiCliente + '/Insertar',
      cliente,
      { headers: this.headers }
    );
  }

  ingresarClienteByBlog(cliente: Cliente): Observable<any> {
    return this.http.post(
      this.appUrl + this.apiCliente + '/cliente/Insertar',
      cliente
    );
  }
  eliminarCliente(id?: string): Observable<any> {
    return this.http.delete(this.appUrl + this.apiCliente + '/Eliminar/' + id, {
      headers: this.headers,
    });
  }
  actualizarCliente(rol: Cliente): Observable<any> {
    return this.http.post(this.appUrl + this.apiCliente + '/Actualizar', rol, {
      headers: this.headers,
    });
  }
  ...
  exportarExcel(rol: string, listar: Listar): Observable<any> {
    ...
    const params = new HttpParams()
      ...
      .set('limit', listar.limit)
      .set('sort', listar.sort);
    return this.http.get(this.appUrl + this.apiCliente + '/Exportar', {
      params: params,
      headers: headers,
      responseType: 'blob',
    });
